...
return [
     ...
     */
    'install_behavior' => env('MARINAR_DELIVERIES_INSTALL_BEHAVIOR', env('MARINAR_INSTALL_BEHAVIOR', true)),
     ...
     * 2 - keep everything
     */
    'delete_behavior' => env('MARINAR_DELIVERIES_DELETE_BEHAVIOR', env('MARINAR_DELETE_BEHAVIOR', false)),
